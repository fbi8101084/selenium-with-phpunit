...
class Forum_post_6Test extends CustomSelenium2TestCase
{
    ...
    {
        //此頁為醫美纖體討論區張貼新話題內頁
        //http://forum.fashionguide.com.tw/post.php?forum_id=6&action=post&LinkTo=TopicL
        $this->url("/post.php?forum_id=6&action=post&LinkTo=TopicL");
        ...
        $this->_assertAdElementPresent('.AdBlock.AdBlock_Loc_134');
        ...
        $this->_assertAdElementPresent('.AdBlock.AdBlock_Loc_147');
