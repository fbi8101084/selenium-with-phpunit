...
class Forum_topic_new_allTest extends CustomSelenium2TestCase
{
    ...
    {
        $this->url("/topic_new_all.php");
        
        // .container
        $el = $this->byXPath('//*[@id="adPos_fbit-0"]/table/tbody/tr[2]/td/div/div[1]/div[1]/div/a/img');
        $this->assertTrue($this->_assertRequestStatus($el->attribute('src')), '圖片可能有破圖');
        $el = $this->byXPath('//*[@id="adPos_fbit-0"]/table/tbody/tr[2]/td/div/div[2]/div[1]/div/a/img');
        $this->assertTrue($this->_assertRequestStatus($el->attribute('src')), '圖片可能有破圖');
        $el = $this->byXPath('//*[@id="adPos_fbit-0"]/table/tbody/tr[2]/td/div/div[3]/div[1]/div/a/img');
        $this->assertTrue($this->_assertRequestStatus($el->attribute('src')), '圖片可能有破圖');

        $el = $this->byXPath('//*[@id="ad_Pos288-0"]/table/tbody/tr[2]/td/div/div[1]/div[1]/div/a/img');
        $this->assertTrue($this->_assertRequestStatus($el->attribute('src')), '圖片可能有破圖');
        $el = $this->byXPath('//*[@id="ad_Pos288-0"]/table/tbody/tr[2]/td/div/div[2]/div[1]/div/a/img');
        $this->assertTrue($this->_assertRequestStatus($el->attribute('src')), '圖片可能有破圖');
        $el = $this->byXPath('//*[@id="ad_Pos288-0"]/table/tbody/tr[2]/td/div/div[3]/div[1]/div/a/img');
        $this->assertTrue($this->_assertRequestStatus($el->attribute('src')), '圖片可能有破圖');
