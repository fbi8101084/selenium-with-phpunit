...
class Forum_post_3Test extends CustomSelenium2TestCase
{
    ...
    {
        //此頁為Freetalk哈啦討論區張貼新話題內頁
        //http://forum.fashionguide.com.tw/post.php?forum_id=3&action=post&LinkTo=TopicL
        $this->url("/post.php?forum_id=3&action=post&LinkTo=TopicL");
