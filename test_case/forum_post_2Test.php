...
class Forum_post_2Test extends CustomSelenium2TestCase
{
    ...
    {
        //此頁為Beauty美容討論區張貼新話題內頁
        //http://forum.fashionguide.com.tw/post.php?forum_id=2&action=post&LinkTo=TopicL
        $this->url("/post.php?forum_id=2&action=post&LinkTo=TopicL");
